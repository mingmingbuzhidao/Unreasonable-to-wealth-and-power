package six二叉搜索树com.mj.printer;
...
public class LevelOrderPrinter extends Printer {
	...
	private void addLineNodes(List<List<Node>> nodes) {
		...
		for (int i = 0; i < rowCount; i++) {
			...
			System.out.println("-------------------------------------------------------------------------------");
			for(Node n:newRowNodes) {
				System.out.println(n.string+","+n.width+","+n.x+","+n.y);
			}
			System.out.println("-------------------------------------------------------------------------------");
			System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
			for(Node w:lineNodes) {
				System.out.println(w.string+","+w.width+","+w.x+","+w.y);
			}
			System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
	...
	private static class Node {
		...
		private void balance(Node left, Node right) {
			...
			System.out.println("left的尾字符,this的首字符,this的尾字符,this的首字符");
            System.out.println(x+","+left.rightX()+","+right.x+","+rightX());
